...
class FileSystem:
    ...
    def load_csv(self):
      ...
      """
      columns = ["id INTEGER PRIMARY KEY", "pid INTEGER","Permissions TEXT","Owner TEXT","_Group TEXT", "Size REAL","Type TEXT", "Created TEXT",
                  "Modified TEXT","Filename TEXT" ,"hidden INTEGER"]
